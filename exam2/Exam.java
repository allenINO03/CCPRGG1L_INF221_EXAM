...
public class Exam {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int surenamelength = surename.length();
        System.out.println(firstnamelength + surenamelength + "total length of your first name and surname"); 
        ...
        String myName = new String("Allen");
        System.out.println("4. Check your first name in LOWERCASE and UPPERCASE");
        System.out.print("Enter your first name in lowercase: ");
        ...
        if(firstNameInLowerCase.toLowerCase().equals("allen")&& firstNameInUpperCase.toUpperCase().equals ("ALLEN")) {
        ...
        if (firstname== firstname.toUpperCase()&& surename==surename.toLowerCase()){
        ...
        if (studentEmailAddress.contains("inocencio")) {
            System.out.println("valid");
        } else {
            System.out.println("invalid"); }
